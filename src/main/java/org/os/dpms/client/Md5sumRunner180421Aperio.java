...
public class Md5sumRunner180421Aperio {
	...
	public static void main(String[] args) throws Exception {
		...
		Md5sumRunner180421Aperio md5 = new Md5sumRunner180421Aperio();
		md5.getAllWsi(szbl);
/*
		for(Slide s: slides) {
		...
		for(File f: list) {
			if(f.isDirectory()) {
				...
				if(f.getName().endsWith("svs")) {
					...
					title = filename.substring(9,filename.indexOf("_")); 
					...
					System.out.println("ndp....."+f.getAbsolutePath());
				}
			}
		}
	}
